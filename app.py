...
def make_scenic_recipe(destinations, horizon_y, label_settings, canvas, art_settings):
    ...
    return {
        ...
        "build_name": "Multi-Style Place Blender 2.3",
...
- Foliage framing: {art_settings.get('foliage_framing', 'Top and bottom foliage')}.
...
# ── SCENIC POSTER / RETRO / WATERCOLOUR QUESTIONS ─────────────────────────
    ...
    if style_name == "Bold Colour Retro Travel Poster":
        ...
        foliage_framing = st.selectbox("Decorative foliage framing", ["Top and bottom foliage", "Top foliage only", "Subtle corner foliage", "No foliage"])
...
label_settings = {
    ...
    "font_style": "elegant classic high-contrast serif lettering inspired by premium travel prints",
    "colour": label_colour,
