...
def make_scenic_recipe(destinations, horizon_y, label_settings, canvas, art_settings):
    ...
    if style_name == "Bold Colour Retro Travel Poster":
        ...
        if poster_finish == "Watercolour retro poster":
            render["finish"] = (
                "Bold modern retro destination-poster composition painted with controlled transparent "
                "watercolour washes, softly feathered pigment edges, visible fine paper texture, simplified "
                "but recognisable landmarks and clean layered poster depth. The watercolour treatment must "
                "remain polished and graphic rather than loose or sketchy."
            )
            render["palette"] = (
                "Luminous saturated watercolour pigments in turquoise, cyan, teal, leaf green, sunshine yellow, "
                "coral pink, magenta and deep navy, with preserved white paper and a clean white print margin."
            )
            render["lighting"] = (
                "Bright graphic daylight expressed through transparent layered washes, preserved paper highlights "
                "and simplified high-contrast shadow washes."
            )
            render["exclude"] = (
                "loose ink sketch lines, uncontrolled paint blooms, muddy beige vintage grading, heavy opaque oil-paint texture, "
                "photorealism, 3D rendering, childish clipart, map silhouettes or mixed illustration styles"
            )
    ...
    if style_name == "Bold Colour Retro Travel Poster":
        ...
        finish_line = {
            ...
            "Watercolour retro poster": "use controlled luminous watercolour washes while preserving bold retro poster structure and landmark clarity",
...
- Keep the landmark dominant and instantly recognisable. Use vivid saturated flat colour shapes and crisp graphic layering throughout.
"""
...
# ── SCENIC POSTER / RETRO / WATERCOLOUR QUESTIONS ─────────────────────────
    ...
    if style_name == "Bold Colour Retro Travel Poster":
        ...
        poster_finish = st.selectbox(
            ...
            index=0,
            help="Choose crisp flat poster shapes, a lightly painted graphic finish, or a controlled bold watercolour version of the same retro composition."
        )
