...
def make_scenic_recipe(destinations, horizon_y, label_settings, canvas, art_settings):
    ...
    return {
        ...
        "build_name": "Multi-Style Place Blender 2.2",
...
# ── SCENIC POSTER / RETRO / WATERCOLOUR QUESTIONS ─────────────────────────
    ...
    style_help = {
        ...
        "Vintage Retro Poster": "Bold simplified mid-century travel-poster art.",
    ...
    with st.expander("Labels, flags and personalisation"):
        ...
        if include_labels:
            label_colour = st.selectbox("Label colour", ["warm cream-gold", "warm cream", "soft white", "golden yellow"])
